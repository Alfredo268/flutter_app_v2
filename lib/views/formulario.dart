...
class _FormPageState extends State<FormPage> {
  ...
  void loadDataIndicador() {
    indicadores = [];
    indicadores.add(new DropdownMenuItem(
        child: new Text('Producto interno bruto'), value: 'PIB'));
    indicadores
        .add(new DropdownMenuItem(child: new Text('Desempleo'), value: 'TDA'));
    indicadores
        .add(new DropdownMenuItem(child: new Text('Inflacion'), value: 'IFL'));
    indicadores.add(
        new DropdownMenuItem(child: new Text('Tasa de cambio'), value: 'TSC'));
  }

  void loadDataAno() {
    ano = [];
    ano.add(new DropdownMenuItem(child: new Text('2005'), value: 2005));
    ano.add(new DropdownMenuItem(child: new Text('2006'), value: 2006));
    ano.add(new DropdownMenuItem(child: new Text('2007'), value: 2007));
    ano.add(new DropdownMenuItem(child: new Text('2008'), value: 2008));
    ano.add(new DropdownMenuItem(child: new Text('2009'), value: 2009));
    ano.add(new DropdownMenuItem(child: new Text('2010'), value: 2010));
    ano.add(new DropdownMenuItem(child: new Text('2011'), value: 2011));
    ano.add(new DropdownMenuItem(child: new Text('2012'), value: 2012));
    ano.add(new DropdownMenuItem(child: new Text('2013'), value: 2013));
    ano.add(new DropdownMenuItem(child: new Text('2014'), value: 2014));
    ano.add(new DropdownMenuItem(child: new Text('2015'), value: 2015));
    ano.add(new DropdownMenuItem(child: new Text('2016'), value: 2016));
    ano.add(new DropdownMenuItem(child: new Text('2017'), value: 2017));
    ano.add(new DropdownMenuItem(child: new Text('2018'), value: 2018));
    ano.add(new DropdownMenuItem(child: new Text('2019'), value: 2019));
    ano.add(new DropdownMenuItem(child: new Text('2020'), value: 2020));
  }

  void loadDataAno2() {
    ano2 = [];
    ano2.add(new DropdownMenuItem(child: new Text('2005'), value: 2005));
    ano2.add(new DropdownMenuItem(child: new Text('2006'), value: 2006));
    ano2.add(new DropdownMenuItem(child: new Text('2007'), value: 2007));
    ano2.add(new DropdownMenuItem(child: new Text('2008'), value: 2008));
    ano2.add(new DropdownMenuItem(child: new Text('2009'), value: 2009));
    ano2.add(new DropdownMenuItem(child: new Text('2010'), value: 2010));
    ano2.add(new DropdownMenuItem(child: new Text('2011'), value: 2011));
    ano2.add(new DropdownMenuItem(child: new Text('2012'), value: 2012));
    ano2.add(new DropdownMenuItem(child: new Text('2013'), value: 2013));
    ano2.add(new DropdownMenuItem(child: new Text('2014'), value: 2014));
    ano2.add(new DropdownMenuItem(child: new Text('2015'), value: 2015));
    ano2.add(new DropdownMenuItem(child: new Text('2016'), value: 2016));
    ano2.add(new DropdownMenuItem(child: new Text('2017'), value: 2017));
    ano2.add(new DropdownMenuItem(child: new Text('2018'), value: 2018));
    ano2.add(new DropdownMenuItem(child: new Text('2019'), value: 2019));
    ano2.add(new DropdownMenuItem(child: new Text('2020'), value: 2020));
  }

  void loadDataPais2() {
    pais2 = [];
    pais2
        .add(new DropdownMenuItem(child: new Text('Afghanistan'), value: 'AF'));
    pais2.add(
        new DropdownMenuItem(child: new Text('Åland Islands'), value: 'AX'));
    ...
    pais2.add(
        new DropdownMenuItem(child: new Text('American Samoa'), value: 'AS'));
    ...
    pais2.add(new DropdownMenuItem(
        child: new Text('Antigua and Barbuda'), value: 'AG'));
    ...
    pais2.add(new DropdownMenuItem(
        child: new Text('Bosnia and Herzegovina'), value: 'BA'));
    pais2.add(new DropdownMenuItem(child: new Text('Botswana'), value: 'BW'));
    pais2.add(
        new DropdownMenuItem(child: new Text('Bouvet Island'), value: 'BV'));
    pais2.add(new DropdownMenuItem(child: new Text('Brazil'), value: 'BR'));
    pais2.add(new DropdownMenuItem(
        child: new Text('British Indian Ocean Territory'), value: 'IO'));
    pais2.add(new DropdownMenuItem(
        child: new Text('British Virgin Islands'), value: 'VG'));
    pais2.add(new DropdownMenuItem(
        child: new Text('Brunei Darussalam'), value: 'BN'));
    pais2.add(new DropdownMenuItem(child: new Text('Bulgaria'), value: 'BG'));
    pais2.add(
        new DropdownMenuItem(child: new Text('Burkina Faso'), value: 'BF'));
    ...
    pais2.add(
        new DropdownMenuItem(child: new Text('Cayman Islands'), value: 'KY'));
    pais2.add(new DropdownMenuItem(
        child: new Text('Central African Republic'), value: 'CF'));
    ...
    pais2.add(
        new DropdownMenuItem(child: new Text('Christmas Island'), value: 'CX'));
    pais2.add(new DropdownMenuItem(
        child: new Text('Clipperton Islands'), value: 'CP'));
    pais2.add(new DropdownMenuItem(
        child: new Text('Cocos (Keeling) Islands'), value: 'CC'));
    ...
    pais2.add(new DropdownMenuItem(
        child: new Text('Congo-Brazzaville'), value: 'CG'));
    pais2.add(
        new DropdownMenuItem(child: new Text('Cook Islands'), value: 'CK'));
    pais2.add(new DropdownMenuItem(child: new Text('Costa Rica'), value: 'CR'));
    pais2.add(
        new DropdownMenuItem(child: new Text('Côte DIvoire'), value: 'CI'));
    ...
    pais2.add(new DropdownMenuItem(
        child: new Text('Dominican Republic'), value: 'DO'));
    ...
    pais2
        .add(new DropdownMenuItem(child: new Text('El Salvador'), value: 'SV'));
    pais2.add(new DropdownMenuItem(
        child: new Text('Equatorial Guinea'), value: 'GQ'));
    ...
    pais2.add(
        new DropdownMenuItem(child: new Text('Falkland Islands'), value: 'FK'));
    pais2.add(
        new DropdownMenuItem(child: new Text('Faroe Islands'), value: 'FO'));
    ...
    pais2.add(
        new DropdownMenuItem(child: new Text('French Guiana'), value: 'GF'));
    pais2.add(
        new DropdownMenuItem(child: new Text('French Polynesia'), value: 'PF'));
    pais2.add(new DropdownMenuItem(
        child: new Text('French Southern Territories'), value: 'TF'));
    ...
    pais2.add(
        new DropdownMenuItem(child: new Text('Guinea-Bissau'), value: 'GW'));
    ...
    pais2.add(new DropdownMenuItem(
        child: new Text('Heard Island and McDonald Islands'), value: 'HM'));
    ...
    pais2
        .add(new DropdownMenuItem(child: new Text('Isle of Man'), value: 'IM'));
    ...
    pais2.add(
        new DropdownMenuItem(child: new Text('Liechtenstein'), value: 'LI'));
    ...
    pais2.add(
        new DropdownMenuItem(child: new Text('Marshall Islands'), value: 'MH'));
    ...
    pais2.add(
        new DropdownMenuItem(child: new Text('Myanmar (Burma)'), value: 'MM'));
    ...
    pais2
        .add(new DropdownMenuItem(child: new Text('Netherlands'), value: 'NL'));
    pais2.add(new DropdownMenuItem(
        child: new Text('Netherlands Antilles'), value: 'AN'));
    pais2.add(
        new DropdownMenuItem(child: new Text('New Caledonia'), value: 'NC'));
    pais2
        .add(new DropdownMenuItem(child: new Text('New Zealand'), value: 'NZ'));
    ...
    pais2.add(
        new DropdownMenuItem(child: new Text('Norfolk Island'), value: 'NF'));
    pais2
        .add(new DropdownMenuItem(child: new Text('North Korea'), value: 'KP'));
    pais2.add(new DropdownMenuItem(
        child: new Text('Northern Mariana Islands'), value: 'MP'));
    ...
    pais2.add(new DropdownMenuItem(
        child: new Text('Palestinian Territory (Gaza Strip)'), value: 'PS'));
    pais2.add(new DropdownMenuItem(child: new Text('Panama'), value: 'PA'));
    pais2.add(
        new DropdownMenuItem(child: new Text('Papua New Guinea'), value: 'PG'));
    ...
    pais2
        .add(new DropdownMenuItem(child: new Text('Philippines'), value: 'PH'));
    pais2.add(
        new DropdownMenuItem(child: new Text('Pitcairn Islands'), value: 'PN'));
    ...
    pais2
        .add(new DropdownMenuItem(child: new Text('Puerto Rico'), value: 'PR'));
    ...
    pais2.add(new DropdownMenuItem(
        child: new Text('Sahrawi Arab (Western Sahara)'), value: 'EH'));
    pais2.add(
        new DropdownMenuItem(child: new Text('Saint Barthélemy'), value: 'BL'));
    pais2.add(
        new DropdownMenuItem(child: new Text('Saint Helena'), value: 'SH'));
    pais2.add(new DropdownMenuItem(
        child: new Text('Saint Kitts and Nevis'), value: 'KN'));
    pais2
        .add(new DropdownMenuItem(child: new Text('Saint Lucia'), value: 'LC'));
    pais2.add(
        new DropdownMenuItem(child: new Text('Saint Martin'), value: 'MF'));
    pais2.add(new DropdownMenuItem(
        child: new Text('Saint Pierre and Miquelon'), value: 'PM'));
    pais2.add(new DropdownMenuItem(
        child: new Text('Saint Vincent and the Grenadines'), value: 'VC'));
    ...
    pais2.add(new DropdownMenuItem(
        child: new Text('São Tomé and Príncipe'), value: 'ST'));
    pais2.add(
        new DropdownMenuItem(child: new Text('Saudi Arabia'), value: 'SA'));
    ...
    pais2.add(
        new DropdownMenuItem(child: new Text('Sierra Leone'), value: 'SL'));
    pais2.add(new DropdownMenuItem(child: new Text('Singapore'), value: 'SG'));
    pais2.add(
        new DropdownMenuItem(child: new Text('Sint Maarten'), value: 'SX'));
    ...
    pais2.add(
        new DropdownMenuItem(child: new Text('Solomon Islands'), value: 'SB'));
    pais2.add(new DropdownMenuItem(child: new Text('Somalia'), value: 'SO'));
    pais2.add(
        new DropdownMenuItem(child: new Text('South Africa'), value: 'ZA'));
    pais2.add(new DropdownMenuItem(
        child: new Text('South Georgia and the South Sandwich Islands'),
        value: 'GS'));
    pais2
        .add(new DropdownMenuItem(child: new Text('South Korea'), value: 'KR'));
    pais2
        .add(new DropdownMenuItem(child: new Text('South Sudan'), value: 'SS'));
    ...
    pais2.add(new DropdownMenuItem(
        child: new Text('Svalbard and Jan Mayen'), value: 'SJ'));
    ...
    pais2
        .add(new DropdownMenuItem(child: new Text('Switzerland'), value: 'CH'));
    ...
    pais2.add(new DropdownMenuItem(
        child: new Text('Trinidad and Tobago'), value: 'TT'));
    ...
    pais2.add(
        new DropdownMenuItem(child: new Text('Turkmenistan'), value: 'TM'));
    pais2.add(
        new DropdownMenuItem(child: new Text('Turks and Caicos'), value: 'TC'));
    ...
    pais2.add(new DropdownMenuItem(
        child: new Text('United Arab Emirates'), value: 'AE'));
    pais2.add(
        new DropdownMenuItem(child: new Text('United Kingdom'), value: 'GB'));
    pais2.add(
        new DropdownMenuItem(child: new Text('United States'), value: 'US'));
    pais2.add(new DropdownMenuItem(
        child: new Text('United States Minor Outlying Islands'), value: 'UM'));
    pais2.add(new DropdownMenuItem(child: new Text('Uruguay'), value: 'UY'));
    pais2.add(new DropdownMenuItem(
        child: new Text('US Virgin Islands'), value: 'VI'));
    ...
    pais2.add(new DropdownMenuItem(
        child: new Text('Wallis and Futuna'), value: 'WF'));
                  ...
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => HomePage(
                          paisSelected,
                          pais2Selected,
                          anoSelected.toString(),
                          ano2Selected.toString(),
                          indicadorSelected),
                    ));
                  })
            ]),
